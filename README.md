...
- **On Advancing Physical Design Using Graph Neural Networks.** Proceedings of the 41st IEEE/ACM International Conference on Computer-Aided Design (ICCAD), 2022. [paper](https://dl.acm.org/doi/10.1145/3508352.3561094)
...
- **A timing engine inspired graph neural network model for pre-routing slack prediction.** Proceedings of the 59th ACM/IEEE Design Automation Conference (DAC), 2022. [paper](https://dl.acm.org/doi/10.1145/3489517.3530597)
...
- **On Joint Learning for Solving Placement and Routing in Chip Design.** Neural Information Processing Systems (NeurIPS), 2021. [paper](https://arxiv.org/abs/2111.00234)
...
- **Circuit-GNN: Graph Neural Networks for Distributed Circuit Design.** Proceedings of the 36th International Conference on Machine Learning (ICML), 2019. [paper](https://proceedings.mlr.press/v97/zhang19e.html)
...
- **IronMan-Pro: Multiobjective Design Space Exploration in HLS via Reinforcement Learning and Graph Neural Network-Based Modeling.** IEEE Transactions on Computer-Aided Design of Integrated Circuits and Systems, March 2023. [paper](https://ieeexplore.ieee.org/document/9803218)
